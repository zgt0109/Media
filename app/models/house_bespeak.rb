class HouseBespeak < ActiveRecord::Base
  ...
  def send_igetui_app_message
  	...
  	attrs = {role: "site",role_id: house.site_id, token: house.site.try(:token),messageable_id: id, messageable_type: "HouseBespeak" ,source: "house", message: "您有一条预约看房的新订单，请注意查看"}
