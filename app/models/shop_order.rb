class ShopOrder < ActiveRecord::Base
  ...
  def send_message
    ...
    if book_dinner?
      ...
      sms_options = { mobiles: shop_branch.mobile, template_code: 'SMS_6735685', params: { username: user.name, mobile: shop_branch.mobile, total_amount: total_amount, address: address, shop_branch_name: shop_branch.name } }
    end
