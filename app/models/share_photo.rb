class SharePhoto < ActiveRecord::Base
  ...
  def self.respond_share_photo(wx_user, wx_mp_user, keyword)
    ...
    url           = mobile_share_photo_url(supplier_id: wx_mp_user.supplier_id, openid: wx_user.openid, id: share_photo.id)
  ...
  def self.respond_my_photo(wx_user, wx_mp_user, activity)
    ...
    if share_photos.count == 1
      url = mobile_share_photo_url(supplier_id: wx_mp_user.supplier_id, openid: wx_user.openid, id: share_photos.first.id)
