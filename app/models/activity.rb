class Activity < ActiveRecord::Base
  ...
  def return_mobile_share_photo_url(options = {})
    mobile_share_photo_url(subdomain: mobile_subdomain, site_id: site_id, id: options[:share_photo_id], openid: options[:openid])
  end
