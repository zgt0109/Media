...
class AuthAgentController < ApplicationController
  ...
  def wx_oauth_callback
    ...
    if should_return_to?
      ...
      CustomLog::Base.logger('wxoauth', "****** return_to_uri: #{return_to_uri.to_s}")
    ...
    CustomLog::Base.logger('wxoauth', "wx_oauth_callback error: #{error.message} > #{error.backtrace}")
  ...
  def generate_oauth_uri(wx_mp_user, auth_params = {})
    CustomLog::Base.logger('wxoauth', "****** request params: #{params}")
  ...
  def decode_return_to_uri
    ...
    CustomLog::Base.logger('wxoauth', "base64_encoded_uri: #{base64_encoded_uri}, params: #{params}")
