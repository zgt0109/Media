class Pro::BusinessShopsController < WebsiteShared::WebsiteBaseController
  ...
  def new
    ...
    @business_shop.build_activity(supplier: current_user, wx_mp_user: current_user.wx_mp_user, activity_type_id: ActivityType::BUSINESS_SHOP, status: Activity::SETTED)
    render :form
  end
