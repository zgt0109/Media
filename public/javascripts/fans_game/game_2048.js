...
RESOURCE_IMG_PATH = RESOURCE_IMG_PATH || "/images/fans_game/",
...
document.addEventListener("WeixinJSBridgeReady",
	...
	HTMLActuator.prototype.actuate = function (grid, metadata) {
		...
		HTMLActuator.prototype.scoreShareButton = function () {
			...
			shareScore.classList.add("weixin-share-button");
			shareScore.setAttribute("href", "#");
		  shareScore.textContent = "晒高分";
							  ...
							  traversals.x.forEach(function (x) {
							  	traversals.y.forEach(function (y) {
							        ...
							        if (next && next.value === tile.value && !next.mergedFrom) {
							          ...
							          if(merged.value > highestMergedValue) {
							          	highestMergedValue = merged.value;
							          }
