...
FCAPP.REVIEW = FCAPP.REVIEW || {
    ...
    loadReviewList: function() {
        ...
        */
        ...
        $.ajax({
					url: '/app/house_impressions/ugc?' + $.param(data),
					dataType: 'jsonp'
        });
    },
    ...
    loadProList: function() {
        ...
        datafile += 'prolist.js?';
        $.ajax({
						url: '/app/house_impressions/pro_list?' + dt.getDate() + dt.getHours(),
            dataType: "jsonp",
