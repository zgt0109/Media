...
(function(window, klass, Util){
    ...
    PhotoSwipe.Toolbar.EventTypes = {
        ...
        onComment: 'PhotoSwipeToolbarOnComment'
    };
    ...
    PhotoSwipe.Toolbar.getToolbar = function(){
        ...
        return '<div id="btn-close" class="' + PhotoSwipe.Toolbar.CssClasses.close + '"><div class="' + PhotoSwipe.Toolbar.CssClasses.toolbarContent + '"></div></div><div class="' + PhotoSwipe.Toolbar.CssClasses.play + '"><div class="' + PhotoSwipe.Toolbar.CssClasses.toolbarContent + '"></div></div><div class="' + PhotoSwipe.Toolbar.CssClasses.previous + '"><div class="' + PhotoSwipe.Toolbar.CssClasses.toolbarContent + '"></div></div><div class="' + PhotoSwipe.Toolbar.CssClasses.next + '"><div class="' + PhotoSwipe.Toolbar.CssClasses.toolbarContent + '"></div></div>';
...
(function(window, klass, Util){
    ...
    PhotoSwipe.Toolbar.ToolbarClass = klass({
        ...
        initialize: function(cache, options){
            ...
            this.commentEl = Util.DOM.find('.' + PhotoSwipe.Toolbar.CssClasses.comment, this.toolbarEl)[0];
        ...
        handleTap: function(e){
            ...
            }else if(e.target === this.commentEl || Util.DOM.isChildOf(e.target, this.commentEl)){
                action = PhotoSwipe.Toolbar.ToolbarAction.comment;
            }
...
(function(window, klass, Util, Cache, DocumentOverlay, Carousel, Toolbar, UILayer, ZoomPanRotate){
    ...
    PhotoSwipe.PhotoSwipeClass = klass({
        ...
        dispose: function(){
            ...
            Util.Events.remove(this, PhotoSwipe.EventTypes.onComment);
        ...
        onToolbarTap: function(e){
            ...
            switch(e.action){
                ...
                case Toolbar.ToolbarAction.close:
                    closeShow();
                    break;
                case Toolbar.ToolbarAction.comment:
                    commetnLink();
                    break;
