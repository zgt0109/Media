...
class InitDb < ActiveRecord::Migration
  ...
  add_index "activity_survey_answers", ["user_id"], :name => "index_activity_survey_answers_on_user_id"
  ...
  add_index "greet_card_logs", ["greet_card_id"], :name => "index_greet_card_logs_on_greet_card_id"
  add_index "greet_card_logs", ["user_id"], :name => "index_greet_card_logs_on_user_id"

  create_table "greet_card_voices", :force => true do |t|
    t.string   "name"
    t.string   "sound"
    t.integer  "user_id"
    t.string   "media_id"
